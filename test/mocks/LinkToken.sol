...
contract LinkToken is ERC20 {
    ...
    // Temporary override implementations to avoid
    // "Cannot instantiate an abstract contract" errors,
    // since ERC20.sol defines virtual functions without implementations.
    // This prevents LinkToken.sol from being treated as abstract.
    // These can be replaced later with the real token metadata.
